<?php
session_start();
if(!isset($_SESSION['add_csrf_token'])) {
    $_SESSION['add_csrf_token'] = bin2hex(random_bytes(32));
}
if(!isset($_SESSION['remove_csrf_token'])) {
    $_SESSION['remove_csrf_token'] = bin2hex(random_bytes(32));
}
...
if(
    ...
    if ( $_POST['action'] === 'add' ) {
        if($_POST['add_csrf_token'] !== $_SESSION['add_csrf_token']) {
            die("You Lose");
        }
    ...
    if ( $_POST['action'] === 'delete') {
        if($_POST['remove_csrf_token'] !== $_SESSION['remove_csrf_token']) {
            die("You Lose");
        }
        // var_dump($_POST['action']);
        $statement = $database->prepare(
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-center">
                ...
                <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST"
                    ...
                    <input type="hidden" name="add_csrf_token"value="<?php echo $_SESSION['add_csrf_token']; ?>">
            ...
            <div class="mt-4">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <form method="POST" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
                        ...
                        <input type="hidden" name="remove_csrf_token"value="<?php echo $_SESSION['remove_csrf_token']; ?>">
                        <?php if(isset($_SESSION['user'])):?>
